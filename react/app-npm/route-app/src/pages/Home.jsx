        ...
        <>
            ...
            <nav>
                {/* 통상 nav라는 네비게이션 용도 태그 내에서 사용 
                    - className이 같은 class 값을 이용하여 활성/비활성 표시 가능
                    - / -> /about 이동 시 다시 돌아가는 링크
                    */}
...
// /dashboard/:city
// 동적 페이지(/:param), 상위/하위 페이지로 URL 연결(URL 경로 발생)
export const City = () => {
    // 동적으로 데이터를 URL에 전달하는 유형의 페이지 (설정)
    // "/:city" <= 현재 컴포넌트를 동적 데이터가 있는 방식으로 URL을 설정
